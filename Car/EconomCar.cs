...
namespace TaxiService
{
    ...
    public class EconomCar : Car
    {
        ...
        public EconomCar(string name, string model, string number, int seats, TaxistPerson taxist, bool isChildSeat, bool isWheelChair) : base(name, model, number, seats, taxist)
        {
