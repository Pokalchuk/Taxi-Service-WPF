...
namespace TaxiService
{
    ...
    public class LuxuryCar : Car
    {
        ...
        public LuxuryCar(string name, string model, string number, int seats, TaxistPerson taxist, bool isTv, bool isFreeAlcohol) : base(name, model, number, seats, taxist)
        {
            this.IsTv = isTv;
